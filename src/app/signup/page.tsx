  ...
  const handleSignUp = async (formData: FormData) => {
    startTransition(async () => {
      ...
      if (result?.error) {
        ...
        setMessage({ type: 'info', text: 'Check your email to verify your account and then sign in.' })
      }
    })
  }
            ...
            <form className="space-y-4" action={handleSignUp}>
              <div className="space-y-2">
               ...
               <div className="space-y-2">
                ...
                <Input id="username" name="username" type="text" placeholder="your_username" required minLength={3} disabled={isPending}/>
              </div>
              <div className="space-y-2">
