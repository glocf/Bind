...
async function AccountPageContent() {
  ...
  const completionPercent = ((profile?.bio ? 1 : 0) + (profile?.avatar_url ? 1 : 0)) / 2 * 100;
                 ...
                 <div className="space-y-6">
                   ...
                   <div>
                      ...
                      <div className="space-y-3">
                         <Button variant="secondary" className={`w-full justify-start ${profile?.avatar_url ? 'bg-green-500/10 border border-green-500/20 text-green-400' : ''}`} disabled>
                           <CheckCircle className="mr-2 h-4 w-4" /> Upload Avatar
                         </Button>
                         <Button variant="secondary" className={`w-full justify-start ${profile?.bio ? 'bg-green-500/10 border border-green-500/20 text-green-400' : ''}`} disabled>
                            <CheckCircle className="mr-2 h-4 w-4" /> Add a Description/Bio
                         </Button>
                         <Button variant="secondary" className="w-full justify-start" disabled>
                           <LinkIcon className="mr-2 h-4 w-4" /> Add your first link
                         </Button>
                      </div>
                   </div>
